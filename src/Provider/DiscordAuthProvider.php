...
class DiscordAuthProvider
{
  ...
  public function getDiscordUser(string $code)
  {
    $headers = [
  ...
  public function generateLogoutUrl(string $code)
  {
    $params = [
      'access_token' => $code
    ];
    return 'https://discordapp.com/api/oauth2/token/revoke' . '?' . http_build_query($params);
  }
}
